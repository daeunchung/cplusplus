...
그래서 고안된 것이 백트래킹으로 DFS에서 더 이상 유망하지 않은 탐색경로를 배제하여 비효율적인 탐색을 줄일 수 있다.
...
해결하지 못해서 https://chanhuiseok.github.io/posts/baek-1/ 의 코드를 가져온 것 입니다. 
*/
